...
$(document).ready(function() {
    ...
    ***************************************************/
                              if($(".registria_field:input[name*='user[certified_quiz_q4]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q4]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q13]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q13]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q1]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q1]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q8]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q8]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q6]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q6]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q5]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q5]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q3]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q3]']").rules("add", {
            required: true
          });
        }
                    if($(".registria_field:input[name*='user[certified_quiz_q3]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q3]']").tooltip({
            ...
            opacity: 0.7
                                    ...
                                    if($(".registria_field:input[name*='user[certified_quiz_q15][]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q15][]']").rules("add", {
            required: true
          });
        }
                    if($(".registria_field:input[name*='user[certified_quiz_q15][]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q15][]']").tooltip({
            position: "center right",
            offset: [-2, 10],
            effect: "fade",
            opacity: 0.7
                                    ...
                                    if($(".registria_field:input[name*='user[certified_quiz_q12]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q12]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q11]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q11]']").rules("add", {
            required: true
          });
        }
                    if($(".registria_field:input[name*='user[certified_quiz_q11]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q11]']").tooltip({
            position: "center right",
            offset: [-2, 10],
            effect: "fade",
            opacity: 0.7
                                    ...
                                    if($(".registria_field:input[name*='user[certified_quiz_q10]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q10]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q14]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q14]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_q9]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_q9]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q14]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q14]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q13]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q13]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q12]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q12]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q11][]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q11][]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q10]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q10]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q9]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q9]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q8]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q8]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q7]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q7]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q6]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q6]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q5]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q5]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q4]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q4]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q3][]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q3][]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q2][]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q2][]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='user[certified_quiz_uk_q1]']").exists()){
          $(".registria_field:input[name*='user[certified_quiz_uk_q1]']").rules("add", {
            required: true
          });
        }
