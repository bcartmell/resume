...
$(document).ready(function() {
    ...
    ***************************************************/
                                                    if($(".registria_field:input[name*='organization[address_attributes][zip]']").exists()) {
          $(".registria_field:input[name*='organization[address_attributes][zip]']").rules("add", {
            regex: "^[0-9]{5}$".replace(new RegExp("\\.", "g"), "\\\."),
            messages: {
              regex: "Invalid. Valid format: 00000"
            }
          });
        }
                    if($(".registria_field:input[name*='organization[address_attributes][zip]']").exists()){
          $(".registria_field:input[name*='organization[address_attributes][zip]']").rules("add", {
            required: true
                                          ...
                                          if($(".registria_field:input[name*='organization[address_attributes][country]']").exists()){
          $(".registria_field:input[name*='organization[address_attributes][country]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='organization[address_attributes][state]']").exists()){
          $(".registria_field:input[name*='organization[address_attributes][state]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='organization[address_attributes][city]']").exists()){
          $(".registria_field:input[name*='organization[address_attributes][city]']").rules("add", {
            required: true
          });
        }
                                                                      if($(".registria_field:input[name*='organization[address_attributes][address1]']").exists()){
          $(".registria_field:input[name*='organization[address_attributes][address1]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='organization[vendor_identifier]']").exists()){
          $(".registria_field:input[name*='organization[vendor_identifier]']").rules("add", {
            required: true
          });
        }
                                                                                                                        if($(".registria_field:input[name*='organization[phone]']").exists()) {
          $(".registria_field:input[name*='organization[phone]']").rules("add", {
          ...
          $(".registria_field:input[name*='organization[phone]']").rules("add", {
            required: true
                                                                      ...
                                                                      if($(".registria_field:input[name*='organization[entity_type]']").exists()){
          $(".registria_field:input[name*='organization[entity_type]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='organization[doing_business_as]']").exists()){
          $(".registria_field:input[name*='organization[doing_business_as]']").rules("add", {
            required: true
          });
        }
                                          if($(".registria_field:input[name*='organization[legal_name]']").exists()){
          $(".registria_field:input[name*='organization[legal_name]']").rules("add", {
            required: true
          });
        }
                                                                if($(".registria_field:input[name*='organization[email]']").exists()) {
          $(".registria_field:input[name*='organization[email]']").rules("add", {
          ...
          $(".registria_field:input[name*='organization[email]']").rules("add", {
            required: true
                    ...
                    if($(".registria_field:input[name*='organization[email]']").exists()){
          $(".registria_field:input[name*='organization[email]']").tooltip({
            ...
            opacity: 0.7
                              ...
                              if($(".registria_field:input[name*='organization[fax]']").exists()) {
          $(".registria_field:input[name*='organization[fax]']").rules("add", {
            regex: "^[\(]?[0-9]{3}[\)]?[-. ]?[0-9]{3}[-. ]?[0-9]{4}$".replace(new RegExp("\\.", "g"), "\\\."),
            messages: {
              regex: "Invalid.  Valid formats: XXX-XXX-XXXX or (XXX) XXX-XXXX"
            }
                                                ...
                                                if($(".registria_field:input[name*='organization[name]']").exists()){
          $(".registria_field:input[name*='organization[name]']").rules("add", {
            required: true
          });
        }
                                    if($(".registria_field:input[name*='organization[tax_identifier]']").exists()) {
          $(".registria_field:input[name*='organization[tax_identifier]']").rules("add", {
            regex: "^[0-9]{2}-[0-9]{7}$".replace(new RegExp("\\.", "g"), "\\\."),
            messages: {
              regex: "Invalid. Valid format: 00-0000000"
            }
          });
        }
                    if($(".registria_field:input[name*='organization[tax_identifier]']").exists()){
          $(".registria_field:input[name*='organization[tax_identifier]']").rules("add", {
            required: true
                    ...
                    if($(".registria_field:input[name*='organization[tax_identifier]']").exists()){
          $(".registria_field:input[name*='organization[tax_identifier]']").tooltip({
            position: "center right",
            offset: [-2, 10],
            effect: "fade",
            opacity: 0.7
...
$.validator.addMethod("complete_url", function(val, elem) {
  ...
  // Copied from jQuery url method.
  return this.optional(elem)||/^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(val);
});
...
function moveFileUploadValidationFeedback() {
  $('.input-group label.invalid[for="logo"]').detach().insertAfter('.fileupload .input-group');
  if ($('label.invalid[for="logo"]').is(':visible')) {
    $('div.fileupload .input-group').css('border', '1px solid #A94442');
  }
  else {
    $('div.fileupload .input-group').css('border', 'none');
  }
}

function initFileFieldValidations() {
  $.validator.addMethod('imageFileExtension', function(value, element) {
    //If the field is blank, don't validate the extension
    if (value == '') {
      return true;
    }
    var acceptableValues = ['jpg','jpeg','png','gif'];
    ...
    if (acceptableValues.indexOf(extension) != -1)
      ...
      return false;
  }, "image must be a .jpg, .jpeg, .gif, .png");

  $.validator.addMethod('maxFileSize', function(value, element) {
    if (element.files) {
      if (element.files.length>0 && element.files[0].size > 1000000)
        return false;
      else 
        return true;
    }
  ...
  }, "image must not be larger than 1MB");
...
function initUpdateLogo() {
  if ($('img.logo_field').length > 0) {
...
function updateLogo() {
  ...
  $('.registria_field#logo').click();
}

$(document).ready(function() {
  $("#registria_form").bind('invalid-form.validate', 
    function(event, validator) {
      moveFileUploadValidationFeedback()
    }
  );
  ...
  initUpdateLogo();
  $('.logo_field').click(function() {
    updateLogo();
  });

  initFileFieldValidations();
});